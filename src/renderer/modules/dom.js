...
export const dom = {
  ...
  backgroundGroup: byId('backgroundGroup'),
  backgroundToggle: byId('backgroundToggle'),
  autoRestartRow: byId('autoRestartRow'),
  autoRestartToggle: byId('autoRestartToggle'),
  ...
  // Pipelines modal (branching snippet graphs)
  pipelinesOverlay: byId('pipelinesOverlay'),
  pipelinesListView: byId('pipelinesListView'),
  pipelinesList: byId('pipelinesList'),
  addPipelineBtn: byId('addPipelineBtn'),
  closePipelinesBtn: byId('closePipelinesBtn'),
  pipelineEditorView: byId('pipelineEditorView'),
  pipelineNameInput: byId('pipelineNameInput'),
  pipelineDescriptionInput: byId('pipelineDescriptionInput'),
  addPipelineStepBtn: byId('addPipelineStepBtn'),
  autoArrangePipelineBtn: byId('autoArrangePipelineBtn'),
  pipelineCanvasWrap: byId('pipelineCanvasWrap'),
  pipelineCanvas: byId('pipelineCanvas'),
  pipelineEdgesSvg: byId('pipelineEdgesSvg'),
  pipelineEdgeLabels: byId('pipelineEdgeLabels'),
  pipelineNodesLayer: byId('pipelineNodesLayer'),
  pipelineInspector: byId('pipelineInspector'),
  deletePipelineBtn: byId('deletePipelineBtn'),
  cancelPipelineEditBtn: byId('cancelPipelineEditBtn'),
  runPipelineFromEditorBtn: byId('runPipelineFromEditorBtn'),
  savePipelineBtn: byId('savePipelineBtn'),
