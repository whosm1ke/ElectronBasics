// index.ts — main-process entry point. Pure orchestration: wires the
...
import { buildAppIcon } from './icon';
import { createWindow, showWindow, WINDOW_WIDTH, WINDOW_HEIGHT } from './window';
import { createTray, maybeShowTrayHint } from './tray';
...
import { ensureHistoryFile } from './storage/history';
...
// Background processes (see shell/process-manager.ts) are meant to survive
